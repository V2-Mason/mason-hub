...
// 缓动曲线 — cubicBezier 字段是 [outX, outX, inX, inX] 格式
// CSS bezier 转换: bez(outX, 0, inX, 1) (speed=0 时 y 分量固定)
const EASE = {
  // unit_01 分屏: content[2] / content[4]
