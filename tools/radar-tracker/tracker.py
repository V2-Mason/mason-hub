...
def inject_dismiss_buttons(raw_html):
    ...
    # 5) Inject dismiss buttons into news-items
    #    Each news-item has: <div class="news-item...">
    #      <div class="news-number">N</div>
    #      <div class="news-content">...news-title with news-link...</div>
    #    </div>
    def _inject_news_btn(m):
        ...
        # Insert button before the last </div> (the closing of news-item)
        idx = block.rfind("</div>")
    ...
    # 6) Inject dismiss buttons into RSS items
